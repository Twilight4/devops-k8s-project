...
* Local cluster — create + deploy
Create a secret for DB password:
#+begin_src shell
# Create secret
kubectl create secret generic pg-secret --from-literal=password='changeme'
#+end_src
...
# Build image into minikube (locally)
...
# Users and Orders service (through API Gateway or directly)
